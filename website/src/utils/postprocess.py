...
class FilterDetections:
    ...
    def __call__(self,
        ...
        bboxes, scores, labels, valid_detections = tf.image.combined_non_max_suppression(
            ...
            clip_boxes=False,
            name="Combined-NMS")
        bboxes = label_utils.to_norm_format(bboxes)
        return labels, bboxes, scores, valid_detections
