...
from src.models.official_models import efficientnet_builder
# from src.models.official_models import efficientnet_lite_builder
from src.models.official_models import efficientnet_model


def get_model_builder(model_name):
    """Get the model_builder module for a given model name."""
    if model_name.startswith('efficientnet-lite'):
        return None #efficientnet_lite_builder
...
def get_model(model_name, override_params=None, model_dir=None):
    ...
    if model_name.startswith('efficientnet-lite'):
        builder = None # efficientnet_lite_builder
    elif model_name.startswith('efficientnet-'):
