...
from src.models.bifpn import ConvNormAct
...
class BoxClassPredict(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=None, **kwargs):
        ...
        # box_and_class_prediction = tf.concat(values=[box_preds, class_preds], axis=-1)
        return box_preds, class_preds #box_and_class_prediction
