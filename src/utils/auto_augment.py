...
# because file is copied from tensorflow/models repository:
# pylint: disable-all
...
AutoAugment Reference: https://arxiv.org/abs/1805.09501 RandAugment
...
REPLACE_FUNCS = frozenset(
    {"Rotate", "TranslateX", "ShearX", "ShearY", "TranslateY", "Cutout",}
)
...
class ImageAugment(object):
    ...
    def distort(self, image: tf.Tensor) -> tf.Tensor:
        """Given an image tensor, returns a distorted image with the same
        shape.
        Args:
